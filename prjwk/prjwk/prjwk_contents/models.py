...
class VideoBusan(models.Model):
    vid = models.AutoField(primary_key=True)
    contents_path = models.CharField(max_length=100, blank=True, null=True)
    contents_name = models.CharField(max_length=45, blank=True, null=True)
...
class VideoSeoul(models.Model):
    ...
    def can_be_downloaded(self, user):
        return not DownloadedVideo.objects.filter(user=user, video=self).exists()
